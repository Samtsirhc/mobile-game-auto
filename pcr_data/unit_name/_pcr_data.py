...
CHARA_NAME = {
    ...
    1109: ["琪爱儿", "チエル", "Chieru", "千爱瑠", "切露", "茄露", "茄噜", "切噜"],
    ...
    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(Seigakusai)", "运动华", "运动华哥", "圣学祭华", "圣学祭克萝依"],
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "千爱瑠(圣学祭)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣学祭千爱瑠"],
    ...
    1191: ["空花(黑暗)", "クウカ(ノワール)", "Kuuka(Noir)", "黑m"],
    1192: ["真阳(圣诞节)", "マヒル(クリスマス)", "Mahiru(Xmas)", "圣牛", "蛋牛", "圣诞奶牛"],
    ...
    1199: ["宫子(圣诞节)", "ミヤコ(クリスマス)", "Miyako(Xmas)", "圣诞布丁", "圣诞宫子", "蛋丁", "但丁"],
    ...
    1227: ["镜华(夏日)", "キョウカ(サマー)", "Kyouka(Summer)", "水镜华", "水xcw", "水仓唯", "水cw"],
    1228: ["禊(夏日)", "ミソギ(サマー)", "Misogi(Summer)", "未奏希(夏日)", "水禊", "水炸弹人", "水炸", "水未奏希"],
    ...
    1804: ["贪吃佩可(公主)", "ペコリーヌ(プリンセス)", "Pecorine(Princess)", "Pekoriinu(Princess)", "公主吃", "公主饭", "公主吃货", "公主佩可", "公主饭团", "公主🍙", "命运高达", "高达", "命运公主", "高达公主", "命吃", "春哥高达", "🤖🍙", "🤖", "公吃", "pf吃"],
    1805: ["可可萝(公主)", "コッコロ(プリンセス)", "Kokkoro(Princess)", "公主妈", "月光妈", "蝶妈", "蝴蝶妈", "月光蝶妈", "公主可", "公主可萝", "公主可可萝", "月光可", "月光可萝", "月光可可萝", "蝶可", "蝶可萝", "蝶可可萝", "公可", "pf妈"],
